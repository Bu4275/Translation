...
namespace UserActivety
{
    ...
    public class UserActivityHook
    {
        ...
        /// </summary>
        public event System.Windows.Input.MouseEventHandler OnMouseActivity;
        /// <summary>
            ...
            if ((nCode >= 0) && (OnMouseActivity != null))
            {
                ...
                switch (wParam)
                {
                    case WM_LBUTTONDOWN:
                        ...
                        md.LeftButton = System.Windows.Input.MouseButtonState.Pressed;
                        break;
                    case WM_RBUTTONDOWN:
                        //case WM_RBUTTONUP: 
                        //case WM_RBUTTONDBLCLK: 
                        button = MouseButtons.Right;
                        md.RightButton = System.Windows.Input.MouseButtonState.Pressed;
                        break;
                    case WM_MOUSEWHEEL:
                ...
                System.Windows.Input.MouseEventArgs e = new System.Windows.Input.MouseEventArgs(md, 1);

                /*
            //generate event 
            System.Windows.Input.MouseEventArgs e = new System.Windows.Input.MouseEventArgs(
                                               button,
                                               clickCount,
        ...
        public class MouseDevice : System.Windows.Input.MouseDevice
        {
            public System.Windows.Input.MouseButtonState LeftButton { get; set; }
            public System.Windows.Input.MouseButtonState RightButton { get; set; }
            public MouseDevice()
            {
            }

            protected System.Windows.Input.MouseButtonState GetButtonState(System.Windows.Input.MouseButton mouseButton)
            {
                return LeftButton;
            }
            protected System.Windows.Input.MouseButtonState GetButtonStateFromSystem(System.Windows.Input.MouseButton mouseButton)
            {
                return LeftButton;
            }
